            ...
            {noDataExtras.map((c) => {
              ...
              return (
                <li
                  ...
                  className="squircle flex items-center justify-between gap-3 rounded-2xl border-2 border-(--surface-stroke) bg-background p-4 sm:p-5 shadow-[0_2px_0_0_var(--surface-stroke),0_12px_32px_-12px_var(--surface-shadow)]"
                >
