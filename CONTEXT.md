...
**Two voices** — all user-facing freshness copy (narrative, badge, tables) is phrased per gym by whether a visit is logged. _Returning_ voice anchors to "since your visit" (counts are personal and exact, fresh dots allowed). _Anon_ voice describes the gym's activity — last reset, drops this month — and never says "fresh for you" or "never visited", because the 28-day scoring window is invisible and visit history is localStorage-only. See ADR-0003 "Display language".
